...
\begin{figure}[h]
	...
	\footnotesize
	\input{plt/TEM-moden}
	\caption{Amplituden der fundamentalen Mode, der ersten und der zweiten
	Harmonischen in Abhängigkeit von einer
...
\end{figure}
Abbildung \ref{fig:externe_resonatoren_aufbau_littrow} zeigt das sog.
...
\ref{fig:externe_resonatoren__aufbau_littmann}). Dabei wird die erste Ordnung
des Gitters auf einen Spiegel und in dieselbe Richtung wieder zurück in die Diode
...
werden. Strom und Gitterwinkel müssen als simultan verstimmt werden, wobei das
