...
das sog. \textit{Übergangsdipolmatrixelement} $e\bra{\Psi_f}\OPv{r}\ket{\Psi_i}$ für die Zustände
...
muss man allerdings zwischen der induzierten und der spontanen Emission
unterscheiden. Die induzierte Emission findet nur mit vorhandenem
elektromagnetischen Feld statt, während bei der spontanen Emission das Atom spontan in einen
energetisch niedrigeren Zustand fällt und ein Photon der entsprechenden Mode
emittiert (auch ohne Feld).\\
In einem elektromagnetischen Feld mit spektraler Energiedichte
$w(\nu)=n(\nu)h\nu$, bei der $n(\nu)=\pfrac{n}{\nu}$ die
spektrale Photonendichte ist, sind im stationären Gleichgewicht die
...
\end{equation}
mit dem bereits erwähnte Übergangsdipolmatrixelement
...
\end{equation}
Diese Relation ist konsistent mit den in Gl.
