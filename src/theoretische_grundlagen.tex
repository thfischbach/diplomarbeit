...
keine Störstellen entstehen. In Fig. \ref {fig:heterostrukturen} sind einige
...
\begin{figure}[h]
	...
	und spezifische Ausstrahlung $M$.}\label{fig:heterostrukturen}
\end{figure}

\subsubsection{Single- und
Multi-Mode-Diodenlaser}\label{subsubsec:singel_multi_mode_laserdioden}
