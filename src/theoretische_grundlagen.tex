...
Somit ist eine einfach Behandlung mit der Schrödingergleichung nicht mehr möglich. Der Dichtematrix-Formalismus berücksichtigt diese Tatsache
...
\end{equation}
Die Doppler-Verbreiterung nimmt also linear mit der Frequenz des eingestrahlten
...
Beispiel für die inhomogene Linienverbreiterung ist die Doppler-Verbreiterung.
...
Stöße nicht zu homogenen Linienverbreiterung bei. Andernfalls ist die
...
Niveaus des System mit einbezieht. Für ein
...
ersten Schritt, fällt die Ionisatzionseffizient sehr schnell ab (Struktur C), da
...
Vorteil hoher Leistung und großen Durchstimmbereichen von bis zu $300\,$nm den
...
werden. Die dabei verwendete Literatur besteht weitgehendst aus den Lehrbüchern
...
Brechungsindizes räumlich so verändert werden, dass sie durch Totalrefelxion die
...
\begin{figure}[h]
	...
	\caption[gewinn- und indexgeführte Laserdiode]{Das Bild zeigt die Aubauten
	einer gewinngeführter (a) und indexgeführter (b) kantenemittierenden
...
des Valenzbandes und ebenfalls einen größeren Brechnungsindex.\par
...
Leistungen ($>200\,$mW) benötigt als mit Single-Mode-Dioden möglich ist. Mit einen
