...
dieser Arbeit (siehe spätere Kapitel \ref{sec:diodenlaser},
%TODO: !Kapitel Lasereignschaften/Laserverhalten referenzieren
\ldots). Übergänge (hier Linien genannt) sind nicht beliebig scharf, sondern haben
eine Breite, die verschiedene Ursachen hat. Darauf wird in diesem Abschnitt
...
Photonen auf nahezu alle Dopplerklassen erweitert wird. Wie sich in Absch.
...
untersuchten Urans (Abschn.
%TODO: Referenz zu Uran-Abschnitt
\ldots) sind dabei typischerweise mehrere
...
\begin{figure}[h]
	...
	Erklärung im Text (aus \cite{schumann:2005:dissertation})}\label{fig:2D-laserscan_theorie_schumann}
\end{figure}
...
\begin{figure}[h]
	...
	\caption[Bandstruktur Halbleiterlaser]{Bandstruktur eines p-n-Halbleiters mit
	der Fermienergie $E_F$, der Ober- bzw. Untergrenze des Valenz- bzw.
	...
	Laserbetrieb; weitere Erklärung im Text}\label{fig:pn-halbleiter}
\end{figure}
Somit stellt
...
Alternativ ist es auch möglich ein \textit{Antireflex-coating (AR-coating)} für
