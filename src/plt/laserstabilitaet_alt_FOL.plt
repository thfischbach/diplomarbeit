clear
reset
file = "laserstabilitaet_alt_FOL"
datafile = sprintf('../dat/%s.dat',file)

starttime = 1031069746
...
set format x ""
#set xlabel 'Zeit [min]'
set ylabel 'relative Frequenz [MHz]' -1,1
set samples 100000
set xrange [0:120]
plot datafile using (($1-starttime)/60000):4 with linespoints pt 1 lt 1 lc 1
...
set xrange [0:120]
set yrange [0:20]
plot datafile using (($1-starttime)/60000):2 with linespoints pt 1 lt 1 lc 1
