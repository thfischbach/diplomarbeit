clear
reset
file = "linienscans_neues_schema_01_SES"
...
fit gauss_fit(x) datafile using ($3*1000000):4 via a,b,sigma_g,mu
...
plot datafile using ($3*1000000):4 with points title 'Messpunkte' lc rgb '#CC0033',\
