clear
reset
file = "beatfrequenzen_neu_iScan_histogramm"
...
set label 1 sprintf('$2\sigma = (%.2f\pm%.2f)\,$MHz',2*sigma,2*sigma_err) at graph 0.55, 0.95
set label 2 sprintf('$A = (%.0f\pm%.0f)\,$MHz',A,A_err) at graph 0.55, 0.88
set label 3 sprintf('$\mu = (%.2f\pm%.2f)\,$MHz',mu,mu_err) at graph 0.55, 0.81
