...
anschließend durch subtrahieren bzw. addieren der Interfringezeit korrigiert.\par Für den Referenzlaser ist ein FSR-Sprung aufgrund seiner absoluten Stabilität
...
für den Brechungsindex $n=1$ (Vakuumwellenlänge) seriell an den PC, auf dem das
...
PC geschickt. Der Quelltext des Programms für den \textit{Arduino} ist in Anh.
...
praktisch nur einmal durchlaufen, wodurch fixe Laser ihrer aktuellen
Frequenzposition behalten.
